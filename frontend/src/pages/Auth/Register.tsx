      ...
      <div className={`flex flex-col md:flex-row h-screen bg-white transition-opacity duration-500 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-6 sm:px-8 md:px-10 lg:px-16 py-8 md:py-0 bg-white overflow-y-auto">
          ...
          <div className="w-full max-w-[400px]">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3 text-black bg-white">Create an account</h1>
            <p className="text-gray-500 mb-4 sm:mb-6 bg-white">Please enter your details</p>
            
            <div className="mb-3 bg-white">
              <label className="block mb-1 text-black bg-white text-sm">Full name</label>
              <input 
                type="text" 
            ...
            <div className="mb-4 sm:mb-5 bg-white">
              <div className="flex items-start sm:items-center bg-white">
                <input 
                  type="checkbox" 
                  id="terms" 
                  className="mr-2 h-4 w-4 mt-1 sm:mt-0 bg-white"
                />
                <label htmlFor="terms" className="text-gray-600 text-xs sm:text-sm bg-white">
            ...
            <p className="text-center mt-4 sm:mt-5 text-gray-600 bg-white text-sm">
              Already have an account? <a onClick={() => navigate(AppRoutes.Login)} className="text-purple-700 font-medium bg-white cursor-pointer">Sign in</a>
            </p>
          </div>
        </div>
      </div>
